...
@implementation BFSDK_WebViewProgressView
...
-(void)configureViews
{
    ...
    UIColor *tintColor = [UIColor colorWithRed:107 / 255.f green:188 / 255.f blue:99 / 255.f alpha:1.0]; // iOS7 Safari bar color
