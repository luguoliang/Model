...
NSString *completeRPCURLPath = @"/BFSDK_Webviewprogressproxy/complete";

const float BFSDK_InitialProgressValue = 0.1f;
const float BFSDK_InteractiveProgressValue = 0.5f;
const float BFSDK_FinalProgressValue = 0.9f;

@implementation BFSDK_WebViewProgress
{
...
- (void)startProgress
{
    if (_progress < BFSDK_InitialProgressValue) {
        [self setProgress:BFSDK_InitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? BFSDK_FinalProgressValue : BFSDK_InteractiveProgressValue;
