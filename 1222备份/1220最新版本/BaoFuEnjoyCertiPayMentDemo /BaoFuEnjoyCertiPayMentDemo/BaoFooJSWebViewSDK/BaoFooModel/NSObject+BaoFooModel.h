//
//  NSObject+BFModel.h
//  BFModel <https://github.com/ibireme/BFModel>
//
 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `BFModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface BFAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation BFAuthor
     @end
 
     @interface BFBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) BFAuthor *author;
     @end
     ...
     int main() {
         ...
         BFBook *book = [BFBook bf_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book bf_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface BFShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation BFShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self bf_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self bf_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self bf_modelCopy]; }
     - (NSUInteger)hash { return [self bf_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self bf_modelIsEqual:object]; }
     @end
 ...
 */
+ (nullable instancetype)bf_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)bf_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)bf_modelToJSONObject;
 ...
 */
- (nullable NSData *)bf_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)bf_modelToJSONString;
 ...
 */
+ (nullable NSArray *)bf_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (BFModel)
...
/**
 ...
 @return A array, or nil if an error occurs.
 */
+ (nullable NSDictionary *)bf_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<BFModel>' to your class header.
 */
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class BFShadow, BFBorder, BFAttachment;
 
        @interface BFAttributes
        @property NSString *name;
        ...
        @implementation BFAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [BFShadow class],
                     @"borders" : BFBorder.class,
...
/**
 ...
 Example:
        @class BFCircle, BFRectangle, BFLine;
 
        @implementation BFShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [BFCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [BFRectangle class];
